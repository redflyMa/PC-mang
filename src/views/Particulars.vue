...
export default {
  ...
  methods: {
    ...
    shoucang() {
      ...
      axios
        .post("http://192.168.11.132:1314/api/fav/addF", data)
        .then(res => {
          console.log(res);
          this.isshow = false;
        })
    ...
    quxiaoshoucang() {
      ...
      axios
        .delete("http://192.168.11.132:1314/api/fav/del", { params: data })
        .then(res => {
          console.log(res);
          this.isshow = true;
        })
    ...
    jiarugouwuche() {
      ...
      let gouwuche = [];
      axios
        .get("http://192.168.11.132:1314/api/cart/pro", {
          params: data1
        })
        .then(res => {
      ...
      function chongfu(i) {
        ...
        axios.put("http://192.168.11.132:1314/api/cart/Pro", data).then(res => {
          console.log("重复已存");
      ...
      function buchongfu() {
        ...
        axios
          .post("http://192.168.11.132:1314/api/cart/addPro", data)
          .then(res => {
            console.log("不重复，已存");
            othis.$message("已添加购物车");
          });
  ...
  created() {
    console.log(this.id)
    this.$axios.get("http://192.168.11.132:1314/api/detail").then(res => {
      //console.log(res);
      ...
      axios
        .get("http://192.168.11.132:1314/api/fav/pro",{params:data})
        .then(res => {
          console.log("bb")
          console.log(res);
          for(let i = 0;i<res.data.length;i++){
